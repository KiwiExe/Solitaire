    ...
    public static void main(String[] args) {
         ...
         */
            ...
            do{
                ...
                pile = input.nextLine();
            } while (!pile.equals("Hand") && !pile.equals("Waste") && !pile.equals("C") && !pile.equals("D") && !pile.equals("H") && !pile.equals("S") && !pile.equals("1") && !pile.equals("2") && !pile.equals("3") && !pile.equals("4") && !pile.equals("5") && !pile.equals("6") && !pile.equals("7"));

            // If the player selected a column, get the card number
            int cardNumber = 0;
            if(pile.equals("1") || pile.equals("2") || pile.equals("3") || pile.equals("4") || pile.equals("5") || pile.equals("6") || pile.equals("7")){
                System.out.println("Select Card Number: ");
                do{
                    System.out.println("Please enter an integer between 1 and " + table.getNumCards((Integer.parseInt(pile))));
                }
